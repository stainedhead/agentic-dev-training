...
async function build() {
  ...
  pres.title  = "Module 6: Spec-Driven Development & PRDs";
  ...
  // ══════════════════════════════════════════════════════════════════
  {
    ...
    s.addText("NEXT  \u00B7  Module 07: Review Cycles, Human-in-the-Loop & Agent-to-Agent  \u2014  Human gates, evaluator patterns, agent as educator", {
      x: 0.35, y: 4.75, w: 9.3, h: 0.62, fontSize: 11.5, color: C.white, bold: true, align: "center", valign: "middle", margin: 0
    });
  }

  await pres.writeFile({ fileName: "Module_06_SDD_PRDs.pptx" });
