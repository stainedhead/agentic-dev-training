...
async function build() {
  ...
  pres.title = "Module 7: Review Cycles, Human-in-the-Loop & Agent-to-Agent";
  ...
  // SLIDE 12 — Discussion + Summary
  {
    ...
    s.addText("NEXT  \u00B7  Module 08: Review Hygiene & Continuous Improvement  \u2014  ADRs, supervised development, quality gates", {x:0.35,y:4.75,w:9.3,h:0.62,fontSize:11.5,color:C.white,bold:true,align:"center",valign:"middle",margin:0});
  }

  await pres.writeFile({ fileName: "Module_07_Review_Cycles.pptx" });
